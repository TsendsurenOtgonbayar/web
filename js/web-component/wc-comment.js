class WcComment extends HTMLElement {
    constructor() {
        super();
        this.render();
    }
    ...
    render(){
        this.innerHTML = `
            <section id="makeComments">
                <h3>Үнэлгээ өгөх</h3> 
                <div class="UnelgeeFiveStar">
                        <svg data-value="1" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                ...
                <textarea type="text" id="commentText" placeholder="Сэтгэгдэл үлдээх"></textarea>
                <button id="sentButton">Илгээх</button>
            </section>`;
    }
}

window.customElements.define('wc-comment', WcComment);